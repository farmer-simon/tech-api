...
const (
	...
	MustLoginCode         int    = 401
	MustLoginMsg          string = "操作失败，请先登陆后再操作"
	ImproveMemberWaitCode int    = -403000
	ImproveMemberWaitMsg  string = "待审核用户暂无法购买"
	ImproveMemberInfoCode int    = -403001
	ImproveMemberInfoMsg  string = "请先完善资料"
