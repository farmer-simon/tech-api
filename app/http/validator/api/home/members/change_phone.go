...
type ChangePhone struct {
	// 表单参数验证结构体支持匿名结构体嵌套
	OldPhone string `json:"old_phone" form:"old_phone" binding:"required"`
...
func (validVal ChangePhone) CheckParams(context *gin.Context) {
	...
	if extraAddBindDataContext == nil {
		...
		(&home.Members{}).ChangePhone(extraAddBindDataContext)
	}
