...
func (c AddRole) CheckParams(context *gin.Context) {
	...
	if extraAddBindDataContext == nil {
		...
		(&admin.Role{}).Create(extraAddBindDataContext)
	}

}

func (c EditRole) CheckParams(context *gin.Context) {
	...
	if extraAddBindDataContext == nil {
		...
		// 验证完成，调用控制器,并将验证器成员(字段)递给控制器，保持上下文数据一致性
		(&admin.Role{}).Edit(extraAddBindDataContext)
	}

}

func (c IndexRole) CheckParams(context *gin.Context) {
	...
	if extraAddBindDataContext == nil {
		...
		// 验证完成，调用控制器,并将验证器成员(字段)递给控制器，保持上下文数据一致性
		(&admin.Role{}).Index(extraAddBindDataContext)
	}
